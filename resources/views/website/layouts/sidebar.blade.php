    ...
    <ul class="menu-inner py-1">
       ...
       <li class="menu-item {{ Route::is('website.home') || Route::is('website.project_timeline.index') ? 'active open' : '' }}">
        ...
        @php
            ...
            /*
             * Project tidak punya route:
             * website.project.it_approval
             * website.project.it_approved
             * website.project.it_mgr_approval
             * website.project.it_mgr_approved
             * website.project.execution
             * website.project.finished
             *
             * Jadi khusus menu ITD, project dikeluarkan agar tidak muncul error RouteNotFoundException.
             */
            $itdMasterLink = array_values(array_filter($masterLink, function ($link) {
                return $link !== 'project';
            }));
