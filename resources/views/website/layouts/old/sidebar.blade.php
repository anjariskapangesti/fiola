<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if (Auth::user()->hasDepartment('ITD'))
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#approval_it" data-bs-toggle="collapse"
                    href="#">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#approved_it" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-clock-history"></i><span>ITD History</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="approved_it"
                    class="nav-content collapse 
        ...
        @if (Auth::user()->hasDepartment('ITD'))
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#finished" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-clipboard-check"></i><span>Finished</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="finished"
                    class="nav-content collapse 
        ...
        @if (Auth::user()->hasDepartment('ITD'))
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('website.reminder.list') }}">
