@extends('website.layouts.main', ['title' => 'List Device'])

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="d-flex justify-content-between">
                <h5 class="card-header">List Device</h5>
                <a href="{{ route('website.device.create') }}" class="btn btn-success" style="margin: 1.25rem;">Create</a>
            </div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="text-center">
                                        <a href="{{ url('device/edit/') }}/${row.id}" class="btn btn-sm btn-primary">Edit</a>
