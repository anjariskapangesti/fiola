...
@section('content')
    ...
    <section class="section">
        <div class="row">
            ...
            @endif
            <form method="post" action="{{ route('website.device.store') }}" class="needs-validation" novalidate id="myForm">
                @csrf
                <div class="col-lg-12">
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <input type="text" class="form-control" name="cost1" value="{{ old('cost1') }}" id="cost1">
                                        <h3><b>-</b></h3>
                                        <input type="text" class="form-control" name="cost2" value="{{ old('cost2') }}" id="cost2">
                                    </div>
                                </div>
