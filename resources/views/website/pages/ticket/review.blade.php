...
<head>
    ...
    <title>FIOLA &mdash; Review Ticket</title>
            ...
            <div class="authentication-inner p-4" style="max-width: 100% !important;">
                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-3">
                        <a href="{{ route('website.ticket.list') }}" class="app-brand-link gap-2">
                            <span class="app-brand-text demo text-heading fw-semibold"
                                style="color: #9055fd !important; font-size: 36px;">REVIEW TICKET</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" width="100%" style="vertical-align: top;">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <span>Name&emsp;: {{ $ticket->requestor_name }}</span><br>
                                                <span>Phone&emsp;: {{ $ticket->requestor_phone }}</span><br>
                                                <span>Dept.&emsp;: {{ $ticket->requestor_department }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <div class="mb-3">
                                                    <span class="alert alert-info p-1">{{ $ticket->no_reg }}</span>
                                                </div>
                                                <div class="mb-3">
                                                    <b>Detail Problem : </b><br>
                                                    <span>{{ $ticket->detail_case }}</span>
                                                </div>
                                                <div>
                                                    <b>Location&emsp;: </b>{{ $ticket->location }}
                                                </div>
                                                <div class="mb-3">
                                                    <b>Priority&emsp;: </b>{{ $ticket->sla }}
                                                </div>
                                                <div class="mb-3">
                                                    <b>Solution&emsp;: </b>{{ $ticket->solution }}
                                                </div>
                                                <div>
                                                    <b>Reported Date&emsp;: </b>{{ $ticket->created_at }}
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <div>
                                                    <b>PIC&emsp;: </b>{{ $ticket->accepted->name }}
                                                </div>
                                                <div>
                                                    <b>Phone&emsp;: </b>{{ $ticket->accepted->nohp }}
                                                </div>
                                                <div class="mb-3">
                                                    <b>IT Note&emsp;: </b>{{ $ticket->it_note }}
                                                </div>
                                                <div class="mb-3">
                                                    <b>Accepted Date&emsp;: </b>{{ $ticket->it_approval_date }}
                                                </div>

                                                <div>
                                                    <b>Pending Date&emsp;: </b>{{ $ticket->on_progress_date }}
                                                </div>
                                                <div class="mb-3">
                                                    <b>Pending Reason&emsp;: </b>{{ $ticket->on_progress_note }}
                                                </div>

                                                <div>
                                                    <b>Finish Date&emsp;: </b>{{ $ticket->finish_date }}
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                @foreach ($ticket->ticket_photos as $photo)
                                                    <a href="/storage/lampiran/{{ $photo->path }}"
                                        ...
                                        <td>
                                            <div>
                                                <button
                                                    class="alert alert-success">{{ $ticket->final_status }}</button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <hr>
                        <form method="post" action="{{ route('website.ticket.rate', ['id' => $ticket->id]) }}"
                                    ...
                                    <div class="feedback">
                                        <div class="rating">
                                            @php
                                                ...
                                                $isDisabled = !is_null($ticket->review);
                                            @endphp

                                            @foreach ($reviews as $rating => $value)
                                                <input type="radio" name="review" id="rating-{{ $rating }}"
                                                    value="{{ $value }}"
                                                    @if ($ticket->review == $value) checked @endif
