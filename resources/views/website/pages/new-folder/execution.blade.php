@extends('website.layouts.main', ['title' => 'Execution New Folder'])
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.new-folder.execution_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
            ...
            $('#app_table').on('click', '.btn-table-approve', function() {
                ...
                var noteText =
                    'New Folder telah selesai dibuat.\nSilahkan dicek kembali folder servernya. Jika tidak bisa, coba lakukan sign out akun windows, lalu login dan coba kembali.';
            ...
            $('#btn-approve').on('click', function() {
                ...
                let notifikasi_approve = $('#notifikasi_approve').is(':checked') ? 'Ya' :
                    'Tidak';
                $.ajax({
                    url: "{{ route('website.new-folder.execution_approve') }}",
                    type: "POST",
                    data: {
                        id: id_approve,
