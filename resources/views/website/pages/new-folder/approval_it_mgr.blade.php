@extends('website.layouts.main', ['title' => 'ITD Manager Approval New Folder'])
    ...
    <script lang="text/javascript">
        $(function() {
            ...
            var table = $('.table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    'url': "{{ route('website.new-folder.show_it_mgr_approval_ajax') }}",
                },
                columns: [{
                        data: null,
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.new-folder.approve_it_mgr') }}",
                    type: "POST",
                    data: {
                        id: id_new_folder,
