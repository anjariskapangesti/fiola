@extends('website.layouts.main', ['title' => 'Manager Approval Relayout'])
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.relayout.manager_approval_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.relayout.manager_approve') }}",
                    type: "POST",
                    data: {
                        id: id_approve,
