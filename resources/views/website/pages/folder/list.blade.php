@extends('website.layouts.main', ['title' => 'List Folder'])

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="d-flex justify-content-between">
                <h5 class="card-header">List Folder</h5>
                <a href="{{ route('website.folder.create') }}" class="btn btn-success" style="margin: 1.25rem;">Create</a>
            </div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="text-center">
                                        <a href="{{ url('folder/edit/') }}/${row.id}" class="btn btn-sm btn-primary">Edit</a>
