@extends('website.layouts.main', ['title' => 'Data Folder'])
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Data Folder</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-3 table table-responsive">
                    <a href="{{ route('website.folder.create') }}" class="btn btn-success">Add Folder</a>
        ...
        <script>
            ...
            $(document).ready(function() {
                var table = $('#app_table').DataTable({
                    ...
                    'orderable': true,
                    ajax: {
                        url: "{{ route('website.folder.list_ajax') }}",
                    },
                    columns: [{
                            data: null,
                            orderable: true,
