@extends('website.layouts.main', ['title' => 'Manager Approval Request Project'])
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                // "sScrollY": true,
                ajax: {
                    url: "{{ route('website.project.show_manager_approval_ajax') }}",
                },
                columns: [{
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.project.approve_manager') }}",
                    type: "POST",
                    data: {
                        id: id_form_project,
                        type: 'ok',
