...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Form Project</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    <section class="section">
        <div class="row">
            ...
            @endif
            <form method="post" action="{{ route('website.project.update', ['id' => $project->id]) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="budget_type" id="budgetType1"
                                            ...
                                            {{ $project->budget_type === 'budget' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="budget_type" id="budgetType2"
                                            value="unbudget" {{ $project->budget_type === 'unbudget' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="form_type"
                                            ...
                                            {{ $project->form_type === 'registration' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="form_type"
                                            ...
                                            {{ $project->form_type === 'deletion' ? 'checked' : '' }}>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <select name="department" class="form-control" required data-toggle="tooltip"
                                        ...
                                        <option selected value="{{ $project->department }}">{{ $project->department }}
                                        </option>
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Phone Number (0812345678910)"
                                        ...
                                        data-placement="top" title="No. HP" value="{{ $project->phone }}">
                                    <div class="invalid-feedback">Please enter your phone number</div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"
                                            name="purpose" maxlength="100" required data-toggle="tooltip" data-placement="top" title="Alasan membuat akun">{{ $project->purpose }}</textarea>
                            ...
                            <div class="row g-3">
                                <div class="col-md-5">
                                    <input type="text" class="form-control"
                                        ...
                                        value="{{ $project->ad_name }}">
                                    <div class="invalid-feedback">Please enter your username</div>
                                </div>
                                <div class="col-md-7">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                            name="is_email" value="true" {{ $project->is_email ? 'checked' : '' }}>
