@extends('website.layouts.main', ['title' => 'List Subfolder'])
    ...
    <script>
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="text-center">
                                        <a href="{{ url('subfolder/edit/') }}/${row.id}" class="btn btn-sm btn-primary">Edit</a>
            ...
            $('#btn-approve-delete').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.subfolder.destroy') }}",
                    type: "POST",
                    data: {
                        id: id_delete,
                        '_token': "{{ csrf_token() }}",
