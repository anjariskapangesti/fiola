@extends('website.layouts.main', ['title' => 'Manager Approval Fitur'])

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="d-flex justify-content-between">
                <h5 class="card-header">Request Fitur for Application (FRM-ITD-S13-047-00)</h5>
            </div>
            <div class="row">
                @if (Session::get('info'))
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.fitur.manager_approval_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.fitur.manager_approve') }}",
                    type: "POST",
                    data: {
                        id: id_approve,
