@extends('website.layouts.main', ['title' => 'ITD Manager Approval VPN'])
        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-3 table table-responsive">
                    {{-- <a href="{{ route('website.vpn.show_data_it_mgr_approval') }}" class="btn btn-primary">Show Data</a> --}}
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'serverSide': true,
                ajax: {
                    url: "{{ route('website.vpn.show_it_mgr_approval_ajax') }}",
                },
                columns: [{
