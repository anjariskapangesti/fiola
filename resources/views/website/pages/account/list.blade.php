        ...
        `
            ...
            $(document).ready(function() {
                var table = $('#app_table').DataTable({
                    ...
                    'serverSide': true,
                    ajax: {
                        url: "{{ route('website.account.list_ajax') }}",
                    },
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                ...
                                `;
                                    ...
                                    return `<a href="/account/edit/${row.id}" class="btn btn-primary btn-sm mt-1">
                                                Edit
                                            </a>
                                            <button class="btn btn-danger btn-sm btn-table-delete mt-1" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="${data.id}" data-fullname="${data.fullname}" data-ad_name="${data.ad_name}">Delete</button>`;
                                } else {
                                    return `Not yet`;
                                }
                            }
