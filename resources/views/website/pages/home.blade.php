        ...
        <div class="row gy-4">
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    ...
                    <img src="{{ asset('vendor/materio/assets/img/icons/misc/triangle-light.png') }}"
                    ...
                    <img src="{{ asset('vendor/materio/assets/img/illustrations/trophy.png') }}"
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 pb-md-2">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('vendor/materio/assets/img/icons/misc/zipcar.png') }}"
                            ...
                            <li class="d-flex mb-4 pb-md-2">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('vendor/materio/assets/img/icons/misc/bitbank.png') }}"
                            ...
                            <li class="d-flex mb-md-3">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('vendor/materio/assets/img/icons/misc/aviato.png') }}"
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/payments/gumroad.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/payments/mastercard-2.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/payments/stripes.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/payments/american-bank.png') }}"
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/payments/citi.png') }}"
                        ...
                        <div class="col-12 col-md-6 ps-0 ps-md-3 mt-3 mt-md-2">
                            ...
                            <div class="pt-2">
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/brands/google.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/brands/github.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/brands/slack.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/payments/digital-ocean.png') }}"
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="{{ asset('vendor/materio/assets/img/icons/brands/aws.png') }}"
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/1.png') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/3.png') }}"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/2.png') }}"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/5.png') }}"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/4.png') }}"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/7.png') }}"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3">
                                                <img src="{{ asset('vendor/materio/assets/img/avatars/6.png') }}"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div>
