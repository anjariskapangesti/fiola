            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        @endif
                        <form method="post" action="{{ route('website.support.store') }}" class="needs-validation"
                            id="myForm" novalidate>
                            @csrf
                            <div class="form-floating form-floating-outline mb-4">
                                <select class="form-select" id="shift" name="shift" aria-label="Select">
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="email" class="form-control" id="email" name="email"
                                    value="{{ old('email') }}" placeholder="" style="background-color: #efeff0" readonly />
                                <label for="email">Email <span class="text-danger">*</span></label>
                            </div>
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" class="form-control" id="nohp" name="nohp"
                                    value="{{ old('nohp') }}" placeholder="" style="background-color: #efeff0"
                                    readonly />
