@extends('website.layouts.main', ['title' => 'ITD Manager Approval Hardware'])
        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-3 table table-responsive">
                    {{-- <a href="{{ route('website.hardware.show_data_it_mgr_approval') }}" class="btn btn-primary">Show Data</a> --}}
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'serverSide': true,
                ajax: {
                    url: "{{ route('website.hardware.show_it_mgr_approval_ajax') }}",
                },
                columns: [{
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.hardware.approve_it_mgr') }}",
                    type: "POST",
                    data: {
                        id: id_form_hardware,
                        type: 'ok',
