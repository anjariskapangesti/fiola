@extends('website.layouts.main', ['title' => 'ITD Approval Hardware'])
        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-3 table table-responsive">
                    {{-- <a href="{{ route('website.hardware.show_data_it_approval') }}" class="btn btn-primary">Show Data</a> --}}
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                // "sScrollY": true,
                ajax: {
                    url: "{{ route('website.hardware.show_it_approval_ajax') }}",
                },
                columns: [{
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.hardware.approve_it') }}",
                    type: "POST",
                    data: {
                        id: id_form_hardware,
                        type: 'ok',
