@extends('website.layouts.main', ['title' => 'Execution Software'])

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="d-flex justify-content-between">
                <h5 class="card-header">Standard Setting Change (Software Installation) Form (FRM-ITD-S13-005-00)</h5>
            </div>
            <div class="row">
                @if (Session::get('info'))
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating form-floating-outline">
                        <textarea class="form-control auto-resize" id="finish_note_approve" name="finish_note_approve"
                            placeholder="add note if there are additional" style="height: 110px;">{{ old('finish_note_approve') }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.software.execution_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
                ...
                return (
                    ...
                    <table class="table table-bordered table-sm" style="background-color: #ebf1f2;">
                        <tbody style="border: 2px solid black;">
                            ...
                            <tr>
                                <td style="background-color: #66a7e3; width: 30px; font-weight: bold;">Application Name</td>
                                <td>${d.appname}</td>
                            </tr>
                            <tr>
                                <td style="background-color: #66a7e3; width: 30px; font-weight: bold;">Device Name</td>
                                <td>${d.installon}</td>
                            </tr>
                            <tr>
            ...
            $('#app_table').on('click', '.btn-table-approve', function() {
                ...
                var noteText =
                    'Form Software telah selesai. Silahkan cek kembali aplikasinya\n\n';
            ...
            $('#btn-approve').on('click', function() {
                ...
                let notifikasi_approve = $('#notifikasi_approve').is(':checked') ? 'Ya' :
                    'Tidak';
                $.ajax({
                    url: "{{ route('website.software.execution_approve') }}",
                    type: "POST",
                    data: {
                        id: id_approve,
