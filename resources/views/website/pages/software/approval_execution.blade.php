        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-3 table table-responsive">
                    {{-- <a href="{{ route('website.software.show_data_execution') }}" class="btn btn-primary">Show Data</a> --}}
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'serverSide': true,
                ajax: {
                    url: "{{ route('website.software.show_execution_ajax') }}",
                },
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `
                            <button class="btn btn-success btn-sm btn-table-approve" data-bs-toggle="modal" data-bs-target="#confirmModal" data-id="${data.id}" data-appname="${data.appname}" data-ad_name="${data.ad_name}">Approve</button>
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.software.approve_execution') }}",
                    type: "POST",
                    data: {
                        id: id_form_software,
                        type: 'ok',
