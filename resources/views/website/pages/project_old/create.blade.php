                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="NPK" name="npk"
                                        style="background: #dbdbdb;" id="npk" maxlength="6"
                                        value="{{ Auth::user()->npk }}" readonly required>
                                    <div class="invalid-feedback">Please enter your NPK</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="fullname"><b>Nama</b></label>
                                    <input type="text" class="form-control" placeholder="Full Name" name="fullname"
                                        style="background: #dbdbdb;" id="fullname" maxlength="60"
                                        value="{{ Auth::user()->name }}" readonly required onkeyup="formatFullName(this)">
                                    <div class="invalid-feedback">Please enter your Full Name</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="phone"><b>No. Handphone</b></label>
                                    <input type="text" class="form-control" placeholder="No Handphone" name="phone"
                                        style="background: #dbdbdb;" id="phone" maxlength="60"
                                        value="{{ Auth::user()->nohp }}" readonly required onkeyup="formatFullName(this)">
                                    <div class="invalid-feedback">Please enter your Full Name</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="department"><b>Department</b></label>
                                    <input type="text" class="form-control" placeholder="Department" name="department"
                                        style="background: #dbdbdb;" id="department" maxlength="14"
                                    ...
                                    <div class="device-container">
                                        <div class="d-flex justify-content-center mb-3" id="div-alat">
                                            ...
                                            <button type="button" class="btn btn-success btn-tambah"
                                                onclick="tambahDevice(this)"><i class="mdi mdi-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function tambahDevice(button) {
            ...
            divAlat.querySelector('.btn-tambah').innerHTML = '<i class="mdi mdi-minus"></i>';
