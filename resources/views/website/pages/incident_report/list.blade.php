@extends('website.layouts.main', ['title' => 'Track Forms Incident Report'])
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.incident_report.list_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
            ...
            $('#btn-delete').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.incident_report.delete_form') }}",
                    type: "POST",
                    data: {
                        id: id_delete,
                        '_token': "{{ csrf_token() }}",
            ...
            $('#btn-confirm').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.incident_report.approve_form') }}",
                    type: "POST",
                    data: {
                        id: id_confirm,
                        type: 'confirm',
