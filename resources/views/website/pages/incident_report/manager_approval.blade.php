@extends('website.layouts.main', ['title' => 'Manager Approval Incident Report'])
    ...
    <script>
        $(document).ready(function() {
            var table = $('#app_table').DataTable({
                ...
                'orderable': true,
                ajax: {
                    url: "{{ route('website.incident_report.manager_approval_ajax') }}",
                },
                columns: [{
                        data: null,
                        orderable: true,
            ...
            $('#btn-approve').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('website.incident_report.manager_approve') }}",
                    type: "POST",
                    data: {
                        id: id_approve,
