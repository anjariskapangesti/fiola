...
<head>
  ...
  <title>FIOLA &mdash; Register</title>
                  ...
                  <form class="form" method="post" action="{{ route('website.auth.create') }}">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="dept_id" class="form-control" id="id_dept" required>
                        <div class="invalid-feedback">Please choose a dept.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="{{ route('website.auth.login') }}">Log in</a></p>
                    </div>
                  </form>
