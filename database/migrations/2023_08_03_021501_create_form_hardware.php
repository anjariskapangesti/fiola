...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('form_hardware', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('device_before',100)->nullable();
            $table->string('device_after', 100)->nullable();
    ...
    {
        Schema::dropIfExists('form_hardware');
    }
};
