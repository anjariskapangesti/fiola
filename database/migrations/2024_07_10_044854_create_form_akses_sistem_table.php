...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('form_akses_sistem', function (Blueprint $table) {
            ...
            $table->boolean('is_dir_approve')->nullable();
            ...
            $table->timestamp('dir_approval_date')->nullable();
            ...
            $table->bigInteger('dir_approve_by')->nullable();
    ...
    {
        Schema::dropIfExists('form_akses_sistem');
    }
};
